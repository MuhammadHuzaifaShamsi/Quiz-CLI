...
if (!answer.testStart) {
    ...
    let score = 0;
    if (quiz.q1 === 'all of the above')
        score++;
    if (quiz.q2 === 'To add static typing to JavaScript')
        score++;
    if (quiz.q3 === 'It represents any type of data')
        score++;
    if (quiz.q4 === 'To define the structure of objects')
        score++;
    if (quiz.q5 === "import { MyModule } from 'my-module'")
        score++;
